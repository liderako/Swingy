...
public class Model {
    ...
    public void createHero(final String name, final String type) throws IOException{
        hero = FactoryHero.newHero(name, type);
        FileManager fileManager = new FileManager();


        fileManager.writeFile(type);
        fileManager.writeFile(" " + name);
        fileManager.writeFile(" " + hero.getInventory().getArmor().getType());
        fileManager.writeFile(" " + hero.getInventory().getWeapon().getType());
        fileManager.writeFile(" " + hero.getInventory().getHelm().getType());
